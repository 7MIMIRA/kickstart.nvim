...
-- Setup instructions for nvim-tree/nvim-tree.lua plugin
...
require('lazy').setup({
  ...
  -- NOTE: The import below can automatically add your own plugins, configuration, etc from `lua/custom/plugins/*.lua`nvim-web-devicons"
